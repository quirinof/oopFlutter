...
class NewNavBar2 extends StatefulWidget {
  @override
  NewNavBarState createState() => NewNavBarState();
}

class NewNavBarState extends State<NewNavBar2> {
  int cIndex = 1;
...
// Analisando os logs percebemos que o build do MyApp, DataBodyWidget e
// NewNavBar são acionados de início, porém após os taps nos botões inferiores,
// apenas o build NewNavBar é acionado, quantas vezes vc clicar.
