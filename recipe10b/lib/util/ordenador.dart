class Ordenador{
  List ordenarFuderoso(List objetos, Decididor decididor, String propriedade){
    ...
    do{
      ...
      for (int i=0; i<objetosOrdenados.length-1; i++){
        ...
        if ( decididor.precisaTrocarAtualPeloProximo(atual, proximo, propriedade) ){
...
abstract class Decididor{
  bool precisaTrocarAtualPeloProximo(dynamic atual, dynamic proximo, String propriedade);
}