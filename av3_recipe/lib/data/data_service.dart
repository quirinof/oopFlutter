...
enum ItemType{
  device, computer, app, none;
  String get asString => '$name';
  List<String> get columns => this == device? ["Nome", "Modelo", "Plataforma"] :
                              this == computer? ["Plataforma", "Tipo", "OS"]:
                              this == app? ["Nome", "Versão", "Autor"]:
                              [] ;
  List<String> get properties => this == device? ["manufacturer","model","platform"] :
                                 this == computer? ["platform","type","os"]:
                                 this == app? ["app_name","app_version","app_author"]:
                                 [] ;
}
